...
export default function AiCoachPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[var(--color-warm-ivory)] text-[var(--color-charcoal)]">
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col px-6 py-6 sm:px-8">
        {showWelcomeModal && (
              ...
              <div className="space-y-5 text-center">
                ...
                <div className="mx-auto mt-4 h-20 w-20 overflow-hidden rounded-full bg-[var(--color-magenta)]/10">
                  <div className="relative h-full w-full">
                    <Image
                      src="/illustrations/em-aicoachv1-full.png"
                      alt="Em AI Coach"
                      fill
        ...
        <div className="rounded-[32px] bg-white p-6 shadow-[0_20px_50px_rgba(0,0,0,0.08)] ring-1 ring-black/5 sm:p-8">
          ...
          <div className="mt-8 grid gap-3">
            {PREDEFINED_PROMPTS.map((prompt) => (
              <button
                ...
                className="rounded-full border border-gray-200 bg-white px-5 py-4 text-left text-sm font-semibold text-[var(--color-charcoal)] shadow-sm transition hover:border-[var(--color-magenta)] hover:bg-[var(--color-magenta)]/10"
              >
                {prompt}
              </button>
            ))}
